...
export default function Categories() {
  ...
  return (
    <div className='mob-categories-container'>
      ...
      <span className='mob-categories-subtitle'>We are the largest, globally-distributed network of top business, design, and technology talent, ready to tackle your most important initiatives.</span>
