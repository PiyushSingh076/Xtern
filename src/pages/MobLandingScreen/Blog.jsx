    ...
    <div className="mob-blog-container">
      ...
      <div className="mob-content-area-container">
        ...
        <div className="mob-blog-list-area">
          {[1, 2, 3, 4, 5].map((items) => (
            <div className="mob-blog-list-card">
              <img src={images} />
              <div>
                <div className="data-type-area">
                  <span style={{ fontSize: "12px" }} className="blog-type">
                    Speaking
                  </span>
                  <span style={{ fontSize: "12px" }} className="blog-date">
                    July,10 2024
                  </span>
                </div>
                <span
