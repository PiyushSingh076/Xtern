...
export default function DesktopAllCategories() {
    ...
    return (
        <div className='categories-container'>
            ...
            <span className='categories-subtitle'>We are the largest, globally-distributed network of top business, design, and technology talent, ready to tackle your most important initiatives.</span>
    
        <div className='categories-card-container'>
            {categories.map((category, index) => (
        <div key={index} className='categories-card'>
            <div className='catedories-card-icon-title'>
            <img src={category.icon} width={'60px'} alt=""/>
