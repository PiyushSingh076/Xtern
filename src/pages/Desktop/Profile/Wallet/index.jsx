    ...
    <>
      ...
      <section id="wallet-screen">
        <div className="des-wallet-container">
          <div className="wallet-screen-wrap">
            <div className="wallet-first mt-32">
              ...
              <p className="wallet-txt2 mt-16">You can add up to $1000.00</p>
            </div>
            <div className="wallet-second">
              <div className="mt-32">
                <p className="wallet-txt3">
                  Maximum limit to add money is $1000.00 per month and $10000.00
                  per year.
                </p>
              </div>
              <div className="serachbar-homepage2 mt-24">
                <div className="input-group ">
                  ...
                  <input
                    ...
                    className="form-control search-text1"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="checkout-screen-content">
            ...
            <div className="review-first-sec-wrap mt-32">
              ...
              <div className="view-all-descrip">
                <Link to="/payment-screen">
                  <span className="checkout-addtxt">Add</span>
                  <span>
          ...
          <div className="check-out-payment-bottom">
            <div className="payment-method-checkoutpage-full payment-mode mt-16">
              <Slider {...settings}>
                <Link to="/payment-screen">
                  <div className="check-select-mode check-select-wallet-mode">
                    <input
                      type="radio"
                      data-target="payment-screen.html"
                      id="payment-1"
                      name="payment-option"
                      checked={isChecked}
                    ...
                    />
                    <label
                      className="payment-custom-radio custom-svg"
                      htmlFor="payment-1"
                    >
                      <svg
                        width="51"
                ...
                <Link to="/payment-screen">
                  <div className="check-select-mode check-select-wallet-mode">
                    ...
                    />
                    <label
                      className="payment-custom-radio "
                      htmlFor="payment-2"
                    >
                      <svg
                        width="50"
        ...
        <div className="container">
          <div className="add-to-wallet mt-32">
